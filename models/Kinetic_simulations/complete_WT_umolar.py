...
#-----------------------------
fegp = [0.004, 0.017, 0.050, 0.10, 0.30, 0.70] #FeGP concentrations
ts=10 #timescale
l = ts*60
...
kcat = Vmax/0.026/60
km = 2.2
k_val = 0.035, 19, 0, (kcat/km), 0, kcat # constants default 0.1, 0.001, 0, 12000, 1, 24000
...
A = D*60*400 #Calculate activity from substrate differences, correct for timescale differences
