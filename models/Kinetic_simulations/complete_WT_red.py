...
k_val = 0.21, 0.00025, 0, 24, 1, 895230 # constants default 0.1, 0.001, 0, 12000, 1, 24000
...
A = D*100*100/(1000) #Calculate activity from substrate differences, correct for timescale differences
...
#import from excel
act_ka_rd = pd.read_excel (r'C:\Users\Francisco\ownCloud\ScienceData\Activity Assays\pHmd\FeGP titration\All\Activities.xlsx', sheet_name='WT_rd') 
...
ori_wt_time = np.array([27.3, 33.3, 52.7, 64.7, 112.0, 188.0])
...
# plt.savefig(r'C:\Users\Francisco\ownCloud\ScienceData\Python\pHmd\Models\Time of max act\WT_red_comparison.png',dpi=600,bbox_inches='tight')                
# plt.show()     
