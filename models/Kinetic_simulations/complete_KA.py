...
k_val = 0.12, 0.0008, 0, 21, 1, 145800 # constants default 0.1, 0.001, 0, 6, 1, 48000
...
A = D*100*100/(1000)*2 #Calculate activity from substrate differences
...
#import from excel
act_ka_ox = pd.read_excel (r'C:\Users\Francisco\ownCloud\ScienceData\Activity Assays\pHmd\FeGP titration\All\Activities.xlsx', sheet_name='KA_ox') 
ori_time_act = act_ka_ox.loc[:,'Time']/60

plt.plot(ori_time_act,act_ka_ox.loc[:,'A'],'+',color='brown',markersize=3,mew =0.5, markevery=4, ls='')
plt.plot(ori_time_act,act_ka_ox.loc[:,'B'],'+',color='purple',markersize=3,mew =0.5, markevery=4, ls='')
plt.plot(ori_time_act,act_ka_ox.loc[:,'C'],'+',color='red',markersize=3,mew =0.5, markevery=4, ls='')
plt.plot(ori_time_act,act_ka_ox.loc[:,'D'],'+',color='green',markersize=3,mew =0.5, markevery=4, ls='')
plt.plot(ori_time_act,act_ka_ox.loc[:,'E'],'+',color='orange',markersize=3,mew =0.5, markevery=4, ls='')
plt.plot(ori_time_act,act_ka_ox.loc[:,'F'],'+',color='blue',markersize=3,mew =0.5, markevery=4, ls='')
...
ori_ka_time = np.array([16.7, 24, 48, 64, 104, 107.3])
...
# plt.savefig(r'C:\Users\Francisco\ownCloud\ScienceData\Python\pHmd\Models\Time of max act\K150A_comparison.png',dpi=600,bbox_inches='tight')                
# plt.show()     
