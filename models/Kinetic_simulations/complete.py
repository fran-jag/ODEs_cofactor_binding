...
k_val_wt = 0.21, 0.001, 0, 6, 1, 48000 # constants default 0.1, 0.001, 0, 6, 1, 48000
...
for i in range(len(fegp)):
    ...
    yout = odeint(hcr,y0,tout,k_val_wt)
...
A = D*100*100/(1000)*2.5 #Calculate activity from substrate differences
