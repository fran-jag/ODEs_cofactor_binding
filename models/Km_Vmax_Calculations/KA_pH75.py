...
km = 65
kr = 0
k_val = 0.009, 0.0095, 0, ((kcat-kr)/km), kr, kcat # constants default 0.1, 0.001, 0, 12000, 1, 24000
...
#import from excel
act_wt_ox = pd.read_excel (r'C:\Users\Francisco\ownCloud\ScienceData\Activity Assays\pHmd\FeGP titration\All\Activities.xlsx', sheet_name='KA_rd') 
...
ori_wt_time = np.array([159.33, 174.67, 278.67, 390.00, 363.30, 600])
